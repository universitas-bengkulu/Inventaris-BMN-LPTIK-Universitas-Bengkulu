    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form action="{{ route('barang.transaksi_masuk.update',[$transaksi->id]) }}" method="POST">
                        {{ csrf_field() }} {{ method_field('PATCH') }}
                        <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">Nama Barang</label>
                            <input type="text" name="nama_barang" value="{{ $transaksi->nama_barang }}" class="form-control">
                            <div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="merk" value="{{ $transaksi->merk }}" class="form-control">
                            <div>
                                @if ($errors->has('merk'))
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="kategori" class="form-control" id="bulan">
                                ...
                                <option {{ $transaksi->kategori == "aset" ? 'selected' : '' }} value="aset">Aset</option>
                                <option {{ $transaksi->kategori == "barang_habis_pakai" ? 'selected' : '' }} value="barang_habis_pakai">Barang Habis Pakai</option>
                            </select>
                            <div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="jumlah_barang" value="{{ $transaksi->jumlah_barang }}" class="form-control">
                            <div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="satuan" class="form-control" id="bulan">
                                ...
                                <option {{ $transaksi->satuan == "Unit" ? 'selected' : '' }} value="Unit">Unit</option>
                                <option {{ $transaksi->satuan == "Pcs" ? 'selected' : '' }} value="Pcs">Pcs</option>
                                <option {{ $transaksi->satuan == "Lembar" ? 'selected' : '' }} value="Lembar">Lembar</option>
                            </select>
                            <div>
                        ...
                        <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">Tangal Masuk</label>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="sumber_dana" class="form-control" id="sumber_dana">
                                ...
                                <option {{ $transaksi->sumber_dana == "apbn" ? 'selected' : '' }} value="apbn">Anggaran Pendapatan dan Belanja Negara (APBN)</option>
                                <option {{ $transaksi->sumber_dana == "pnpb" ? 'selected' : '' }} value="pnpb">Penerima Negara Bukan Pajak (PNBP)</option>
                            </select>
                            <div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="kondisi" class="form-control" id="kondisi">
                                ...
                                <option {{ $transaksi->kondisi == "baik" ? 'selected' : '' }} value="baik">Baik</option>
                                <option {{ $transaksi->kondisi == "rusak" ? 'selected' : '' }} value="rusak"> Rusak</option>
                                <option {{ $transaksi->kondisi == "hilang" ? 'selected' : '' }} value="hilang"> Hilang</option>
                            </select>
                            <div>
