...
@section('location2')
    <i class="fa fa-dashboard"></i>&nbsp;Laporan Transaksi Masuk
@endsection
...
@section('content')
    <div class="callout callout-info ">
        <h4>Perhatian!</h4>
        <p>
            Berikut adalah data transaksi keluar barang yang sudah tersedia, silahkan cetak dalam bentuk excel /pdf
            <br>
        </p>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-file-pdf-o"></i>&nbsp;Laporan Transaksi Keluar</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body table-responsive">
                    ...
                    @endif
                    <form action="{{ route('laporan.cari_keluar') }}" method="POST">
